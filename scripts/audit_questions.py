...
def audit_questions():
    ...
    for i in range(1, 101):
        ...
        code_correction_count = sum(
            1 for q in questions if q.get("question_type") == "code-correction"
        )
    ...
    for r in results:
        ...
        print(
            f"{status} Day {r['day']:2d}: Total={r['total']:2d}, MCQ={r['mcq']:2d}, Coding={r['coding']:2d} | Issues: {len(r['issues'])}"
        )
