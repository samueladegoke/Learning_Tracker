...
def test_penalty_logic():
    ...
    try:
        ...
        print("Days since checkin: 3, Days since penalty: 2")
        print(f"Hearts before: {initial_hearts}, Hearts after: {user.hearts}")
        print("Expected: No penalty (already penalized for this break)")
        ...
        print("Days since checkin: 1")
        print(f"Hearts before: {initial_hearts}, Hearts after: {user.hearts}")
        print("Expected: No penalty (1-day grace period)")
        print(f"Result: {'✅ PASS' if user.hearts == initial_hearts else '❌ FAIL'}")
        ...
        print("Days since checkin: 2")
        print(f"Hearts before: {initial_hearts}, Hearts after: {user.hearts}")
        print("Expected: Lose 1 heart (first penalty)")
