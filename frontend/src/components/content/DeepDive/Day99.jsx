...
import { Target, Layers, CheckCircle2, GitBranch, MessageSquareQuote, Sparkles, AlertTriangle, Rocket, BarChart3 } from 'lucide-react'

export default function DeepDiveDay99() {
    return (
                ...
                <section className="space-y-4">
                    ...
                    <div className="bg-surface-800/50 p-5 rounded-lg border border-surface-700">
                        <p className="italic text-surface-300 mb-4">
                            "Analyze the Space Race dataset to explore the history of space exploration, including launch trends, success rates, and country comparisons."
                        </p>
                        ...
                        <ul className="list-disc list-inside space-y-1 text-surface-300">
                            ...
                            <li>Visualizations with Matplotlib/Plotly</li>
                            <li>Jupyter Notebook with insights</li>
                        </ul>
                    </div>
                </section>
                ...
                <section className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="bg-surface-800/30 p-4 rounded-lg border border-surface-700 flex items-start gap-3">
                            <Rocket className="w-5 h-5 text-green-400 mt-1 shrink-0" />
                            <div>
                                <h4 className="font-semibold text-surface-100">Pandas</h4>
                                <p className="text-sm text-surface-400">Data manipulation and analysis.</p>
                            </div>
                        </div>
                        <div className="bg-surface-800/30 p-4 rounded-lg border border-surface-700 flex items-start gap-3">
                            <BarChart3 className="w-5 h-5 text-blue-400 mt-1 shrink-0" />
                            <div>
                                <h4 className="font-semibold text-surface-100">Plotly</h4>
                                <p className="text-sm text-surface-400">Interactive data visualizations.</p>
                            </div>
                        </div>
                    </div>
                </section>
...
# Analysis: Launches per year
launches_by_year = df.groupby('Year').size()

# Visualization
fig = px.line(x=launches_by_year.index, y=launches_by_year.values,
              title='Space Launches Over Time',
...
fig.show()`}
                ...
                <section className="space-y-4">
                    ...
                    <div className="space-y-3">
                        {[
                            { title: "Data Loading", desc: "Import and explore the dataset structure." },
                            { title: "Data Cleaning", desc: "Handle missing values and fix data types." },
                            { title: "EDA", desc: "Calculate statistics and identify patterns." },
                            { title: "Storytelling", desc: "Create narrative with visualizations." }
                        ].map((m, i) => (
                ...
                <section className="space-y-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                        <div className="bg-surface-800/30 p-4 rounded-lg border border-amber-500/20">
                            <h4 className="font-semibold text-amber-300 mb-1">Date Parsing</h4>
                            <p className="text-sm text-surface-400">Different date formats in historical data need careful handling.</p>
                        </div>
                        <div className="bg-surface-800/30 p-4 rounded-lg border border-amber-500/20">
                            <h4 className="font-semibold text-amber-300 mb-1">Survivorship Bias</h4>
                            <p className="text-sm text-surface-400">Consider missing or incomplete records in historical datasets.</p>
                        </div>
                    </div>
                </section>
            </div>
                ...
                <div className="bg-surface-800/40 p-5 rounded-xl border border-surface-700">
                    ...
                    <ul className="space-y-3 text-sm text-surface-300">
                        <li className="flex gap-2 items-start">
                            ...
                            <span>"What was the most surprising insight you found in this data?"</span>
                        </li>
                    </ul>
                </div>
            </aside>
